...
interface ZineOutlineTextProps {
    text: string;
    strokeColor?: string;
    strokeWidth?: number;
    fontSize?: number;
...
/**
 * ZineOutlineText - 使用 SVG 实现的空心文字组件
 * 完美兼容所有浏览器和导出场景
 */
export const ZineOutlineText: React.FC<ZineOutlineTextProps> = ({
    text,
    strokeColor = '#0F172A',
    strokeWidth = 2.5,
    fontSize = 120,
    ...
    return (
        <div
            ref={containerRef}
            className={`zine-outline-text inline-block ${className}`}
            style={{
...
export default ZineOutlineText;
